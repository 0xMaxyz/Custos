...
import { PROTOCOLS, MANTLE_MAINNET_CHAIN_ID } from "@sentinel/shared";
 ...
 *
 *   MANTLE_RPC_URL=http://127.0.0.1:8545 pnpm --filter @sentinel/agent test
 */
...
describeFork("pipeline (fork integration)", () => {
  ...
  it("buildPipeline constructs against resolved shared addresses", () => {
    ...
    // address (the USDY oracle) is unresolved in @sentinel/shared.

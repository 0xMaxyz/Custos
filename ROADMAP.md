...
### 4.4 — Dashboard (reads) · _PR-4b_ · `[x] DONE` (testnet live reads wired in 5.1; live-by-default + live allocation in [PR #28](https://github.com/0xMaxyz/miu/pull/28); agent-computed APY/peg/oracle overlaid from `/snapshot` in [PR #30](https://github.com/0xMaxyz/miu/pull/30); mainnet on 5.2)

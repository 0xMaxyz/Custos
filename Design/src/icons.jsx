/* Line icons (lucide geometry, §2.5). Single set, consistent 2px stroke.
   <Icon name="..." size={16} /> — exported to window.Icon. */
(function () {
  const P = {
    // signal-type icons (§15.1)
  ...
  function Icon({ name, size = 18, stroke = 2, className = "", style = {} }) {
    ...
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24"
        ...
        strokeLinejoin="round" className={className} style={{ flexShrink: 0, ...style }} aria-hidden="true">
        {inner}
      </svg>
    );
  }
